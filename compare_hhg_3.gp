...
plot datafile1.'/hhg.dat' using 1:2 with lines lw 2 lc 8 title label1, \
     datafile2.'/hhg.dat' using 1:2 with lines lw 1 lc 6 title label2, \
     datafile3.'/hhg.dat' using 1:2 with lines lw 1 lc 2 title label3
...
plot datafile1.'density.dat' using 1:3 with lines lw 2 lc 8 title label1, \
     datafile2.'density.dat' using 1:3 with lines lw 1 lc 6 title label2, \
     datafile3.'density.dat' using 1:3 with lines lw 1 lc 2 title label3 
