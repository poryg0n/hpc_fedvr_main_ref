...
!                 nmax, nmax_, krange, ios, nt, order, src_type
      ...
      character(255) :: workdir, struct_dir, dyn_tag
      ...
      call read_problem_bin(trim(struct_dir)//"/problem.bin",        &
                             nmax_, ns, np, xx1, xx2, jacc, xx, wx)
...
!      pause
       ...
       write(log_unit,*) "Check the initial condition"
      ...
      write(log_unit,*) "Saving the dynamic parameters"
